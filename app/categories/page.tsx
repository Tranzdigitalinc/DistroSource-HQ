      ...
      <main className="flex-1">
        <section className="relative overflow-hidden border-b border-border bg-foreground text-background">
          ...
          <div className="relative mx-auto max-w-[1540px] px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
            ...
            <h1 className="mt-4 max-w-5xl font-display text-[clamp(3.4rem,8vw,8rem)] font-black leading-[0.84] tracking-[-0.08em]">
              Find your aisle.
            </h1>
            <div className="mt-7 flex flex-wrap items-center gap-x-5 gap-y-2 text-sm text-background/55">
              <span>{tree.length} departments</span>
        ...
        <div className="mx-auto max-w-[1540px] px-4 py-12 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
          <div className="space-y-20 lg:space-y-24">
            {tree.map((department, departmentIndex) => {
              ...
              return (
                <Reveal key={department.slug} as="section" aria-labelledby={`dept-${department.slug}`}>
                  <div className="grid gap-7 lg:grid-cols-[310px_1fr] lg:gap-12 xl:grid-cols-[360px_1fr]">
                    <div className="lg:sticky lg:top-24 lg:self-start">
                      <div className="flex items-center gap-3 font-mono text-[9px] font-black uppercase tracking-[0.12em] text-muted-foreground">
                        <span>0{departmentIndex + 1}</span>
                        <span className="h-px w-8 bg-border" />
                        {department.productCount} products
                      </div>
                      <span className="mt-6 flex size-14 items-center justify-center rounded-[20px] bg-primary/10 text-primary">
                          ...
                          <RevealItem key={category.slug} className="h-full">
                            ...
                            >
                              ...
                              <div>
                                ...
                                <span className="mt-5 flex items-center justify-between text-xs font-semibold">
                                  Browse products
                                  <span className="flex size-9 items-center justify-center rounded-full bg-foreground text-background transition-transform group-hover:translate-x-1"><ArrowRight size={13} /></span>
                                </span>
                              </div>
                            </Link>
                          </RevealItem>
