...
import { ArrowRight, Download, Grid, ShieldCheck } from "@/lib/storefront-icons"
...
export function RedesignHero({
  ...
  stats: RedesignHeroStats
  products: RedesignHeroProduct[]
}) {
    ...
    <section className="relative isolate overflow-hidden border-b border-border bg-background">
      ...
      <div className="mx-auto grid min-h-[720px] max-w-[1500px] items-center gap-12 px-6 py-16 sm:px-8 lg:grid-cols-[minmax(0,0.9fr)_minmax(520px,1.1fr)] lg:px-10 lg:py-20 xl:gap-20">
        ...
        >
          ...
          >
            One curated source for templates, design assets, business systems, development resources,
            gaming products and the digital pieces that move work forward.
          </motion.p>
          ...
          >
            <HeaderSearch className="w-full shadow-[var(--shadow-e2)]" />
          </motion.div>
          ...
          >
            <Link
              href="/products"
              className="group inline-flex min-h-11 items-center gap-2 bg-primary px-5 py-3 text-sm font-bold text-primary-foreground transition-transform duration-200 hover:-translate-y-0.5"
            >
            ...
            <Link
              href="/categories"
              className="inline-flex min-h-11 items-center gap-2 border border-border-strong bg-background/70 px-5 py-3 text-sm font-bold text-foreground backdrop-blur transition-colors hover:border-primary/50 hover:text-primary"
            >
          ...
          >
            <li className="flex items-center gap-2">
              ...
              <span>
                <strong className="text-foreground">{stats.productCount.toLocaleString()}</strong> products across{" "}
            ...
            <li className="flex items-center gap-2">
              ...
              <span>Secure checkout & clear licensing</span>
            </li>
          </motion.ul>
        </motion.div>
        ...
        >
          ...
          {artwork[0]?.imageUrl && (
            <motion.div
              ...
              className="absolute left-[4%] top-[7%] w-[58%] overflow-hidden border border-border bg-card shadow-[var(--shadow-e2)]"
            >
              <div className="relative aspect-[4/3]">
                <Image src={artwork[0].imageUrl} alt="" fill priority sizes="34vw" className="object-cover" />
              </div>
          ...
          {artwork[1]?.imageUrl && (
            <motion.div
              ...
              transition={{ duration: 0.2 }}
              className="absolute right-[2%] top-[22%] w-[43%] overflow-hidden border border-border bg-card shadow-[var(--shadow-e2)]"
            >
              <div className="relative aspect-square">
                <Image src={artwork[1].imageUrl} alt="" fill sizes="26vw" className="object-cover" />
              </div>
            </motion.div>
          )}
          ...
          {artwork[2]?.imageUrl && (
            <motion.div
              ...
              transition={{ duration: 0.2 }}
              className="absolute bottom-[5%] left-[18%] w-[39%] overflow-hidden border border-border bg-card shadow-[var(--shadow-e2)]"
            >
              <div className="relative aspect-[4/3]">
                <Image src={artwork[2].imageUrl} alt="" fill sizes="24vw" className="object-cover" />
              </div>
            </motion.div>
          )}
          ...
          {artwork[3]?.imageUrl && (
            <motion.div
              whileHover={{ y: -5, rotate: 0.35 }}
              transition={{ duration: 0.2 }}
              className="absolute bottom-[10%] right-[6%] w-[33%] overflow-hidden border border-border bg-card shadow-[var(--shadow-e2)]"
            >
              <div className="relative aspect-[3/4]">
                <Image src={artwork[3].imageUrl} alt="" fill sizes="20vw" className="object-cover" />
              </div>
            </motion.div>
          )}
          ...
          <div className="absolute bottom-[6%] left-[2%] max-w-48 border border-border bg-background px-4 py-3 shadow-[var(--shadow-e1)]">
            ...
            <p className="mt-1 font-display text-2xl font-black tracking-tight text-foreground">
